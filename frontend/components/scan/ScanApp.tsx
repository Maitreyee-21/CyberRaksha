...
import { Menu, Shield, Plus, Sparkles, Home } from 'lucide-react';
...
interface ScanAppProps {
  /** Optional: lets the surrounding app route back to the intro/landing page. Purely navigational — does not touch scan logic. */
  onGoHome?: () => void;
}

export function ScanApp({ onGoHome }: ScanAppProps = {}) {
